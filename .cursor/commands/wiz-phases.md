...
## description: Generate implementation phases from PRD argument-hint: <slug>
...
1. **Middle phases** build features, integrations, and user-facing capabilities
1. **Later phases** focus on quality, optimization, and deployment
...
1. Write them to `.wiz/{SLUG}/phases/phase1.md` through `phaseN.md`
...
1. **Phase Numbers**: Sequential (1, 2, 3, ..., N)
1. **Dependencies**: Valid dependency chain
1. **Milestone Counts**: Each phase has 15-40 milestone placeholder
1. **Goal Clarity**: Each goal is specific and actionable
1. **Acceptance Criteria**: Each phase has 5-10 clear criteria
...
1. Generate 3-15 phases based on PRD complexity
1. Save phase documents to `.wiz/auth-system/phases/phase*.md`
1. Display phase summary with next steps
