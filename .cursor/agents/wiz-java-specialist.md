...
**Relevance Criteria:**
- If `languages` is empty array → applies to all languages (including Java) → relevant
- If `languages` includes "java" → relevant
...
2. **Detailed Report:** Full report saved to `.wiz/.quality-reports/java-[timestamp].md`
3. **Exit Code:**
...
5. Keep checks fast (<120s for typical file, Java builds can be slower)
6. Cache results when possible
7. Report clearly with emojis and formatting
8. Support both Maven and Gradle
9. Handle multi-module projects
